...
public:
    ...
    // Métodos de visualización y estadísticas
    void mostrarGraficoEstadoCuenta(const std::string &numeroCuenta) const;
    ...
    bool guardarRespaldo(const std::string &nombreArchivo, const std::string &tipoArchivo) const;
};
